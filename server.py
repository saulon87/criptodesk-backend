...
async def root() -> Dict[str, Any]:
    return {
        ...
        "endpoints": ["/api/health", "/api/summary", "/api/history"],
    }
...
async def summary() -> Dict[str, Any]:
    ...
    async with httpx.AsyncClient(timeout=settings.request_timeout) as client:
        ...
        response: Dict[str, Any] = {
            ...
            "calculatedTotalUsd": portfolio.get("calculatedTotalUsd", 0.0),
            "assetValuationTotalUsd": portfolio.get("assetValuationTotalUsd", 0.0),
            "assets": portfolio.get("assets", []),
            "stableAssets": portfolio.get("stableAssets", []),
            "otherAssets": portfolio.get("otherAssets", []),
            "sourceSummaries": portfolio.get("sourceSummaries", {}),
