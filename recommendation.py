...
def build_recommendation(portfolio: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if decision == "COMPRAR":
        reason = "La oportunidad es favorable, pero se recomienda usar solo una parte del capital operativo."
    elif decision == "VIGILAR":
        reason = "El mercado mejora, pero todavía conviene esperar confirmación antes de abrir posición."
